...
def testInfoModulesBasic(env):
  ...
  # The TQ-compressed HNSW field is counted in the HNSW bucket.
  env.assertEqual(field_info_to_dict(fieldsInfo['search_fields_vector']), get_search_field_info('Vector', 5, Flat=1, HNSW=2, SVS_VAMANA=2, SVS_VAMANA_Compressed=1))
